...
set_window_value(AT_USPECIAL, 11, AG_WINDOW_HSPEED, flight_speed * 0.4);
set_window_value(AT_USPECIAL, 11, AG_WINDOW_HSPEED_TYPE, 0);
set_window_value(AT_USPECIAL, 11, AG_WINDOW_VSPEED, flight_speed * -1.1);
