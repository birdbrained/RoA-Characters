...
set_window_value(AT_FSPECIAL, 5, AG_WINDOW_HSPEED, -20);
set_window_value(AT_FSPECIAL, 5, AG_WINDOW_HSPEED_TYPE, 0);
set_window_value(AT_FSPECIAL, 5, AG_WINDOW_VSPEED, -20);
set_window_value(AT_FSPECIAL, 5, AG_WINDOW_VSPEED_TYPE, 0);
set_window_value(AT_FSPECIAL, 5, AG_WINDOW_CUSTOM_GRAVITY, 1);*/

set_num_hitboxes(AT_FSPECIAL, 2);

//bonk hitbox - too early!
set_hitbox_value(AT_FSPECIAL, 2, HG_WINDOW, 2);
set_hitbox_value(AT_FSPECIAL, 2, HG_LIFETIME, get_window_value(AT_FSPECIAL, 2, AG_WINDOW_LENGTH) - 10);
set_hitbox_value(AT_FSPECIAL, 2, HG_HITBOX_X, 21);
