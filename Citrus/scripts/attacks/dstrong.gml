...
set_hitbox_value(AT_DSTRONG, 2, HG_LIFETIME, 9);
...
set_hitbox_value(AT_DSTRONG, 2, HG_HITPAUSE_SCALING, 0.75);
...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sound_get("peep_peep"));
